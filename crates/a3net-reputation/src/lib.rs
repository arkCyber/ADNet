//! # a3net-reputation
//!
//! Global peer reputation (PeerScore) for A3Net.
//!
...
//! `crates/a3net-blobstore/src/bitswap.rs`).
//!
//! ## Why a global PeerScore?
//!
//! A3Net has at least three subsystems that independently grade
//! peer behavior:
//!
...
//!   `a3net_reputation_score{peer_hash}` gauge and
//!   `a3net_reputation_event_total{event}` counter.
...
//!
//! ```rust
//! use a3net_reputation::{PeerScoreTable, ReputationEvent, ReputationParams};
