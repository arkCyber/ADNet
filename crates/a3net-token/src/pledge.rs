...
use a3net_identity::{Address, PersonalSignature, Wallet, WalletPublic};
...
impl Pledge {
    ...
    ///
    /// Format: `a3net-token://<chain_id>/<contract>/<token>/<amount>/<recipient>/<nonce>/<expiry>/<sig_hex>`
