...
//! `a3net-token` — relay-billing tokens for A3Net.
//!
...
//!
//! ```text
//! a3net-token://<chain_id>/<contract_addr>/<token_addr>/<amount_atomic>/
...
//! is what travels inside the A3Net gossip layer.
//!
//! ## Why a separate crate
//!
//! - `a3net-types` must stay free of crypto deps to keep the wire contract
//!   cheap to compile.
//! - `a3net-identity` owns the *primitives* (wallets, signatures). This crate
