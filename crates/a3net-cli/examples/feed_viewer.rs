...
//! Run with:
//! ```bash
//! cargo run -p a3net-cli --example feed_viewer
//! ```
...
fn main() -> Result<()> {
    println!("=== A3Net Feed Viewer Demo ===\n");
...
fn create_sample_feed() -> RoomFeed {
    ...
    let assets = vec![
        RoomAsset {
            ...
            title: "Getting Started with A3Net".to_string(),
            kind: CdnContentKind::Article,
            size_bytes: 15420,
            mime_type: Some("text/markdown".to_string()),
            source_url: Some("https://example.com/articles/a3net-intro".to_string()),
            room_id: room.clone(),
