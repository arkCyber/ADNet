...
//! wrapper exposing the [`adnet_types::MeshRosterSigner`] /
//! [`adnet_types::MeshRosterVerifier`] traits so callers don't have
...
use adnet_types::{MeshMembership, MeshRosterSigner, MeshRosterVerifier};
...
pub use adnet_types::verify_roster_signature as verify_with_trait;

#[cfg(test)]
mod tests {
    use super::*;
    use adnet_types::{MeshMember, MeshMembership, MeshNetworkId, NodeId};
