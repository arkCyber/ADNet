...
//! `a3net-reputation` is the authoritative aggregator when
...
pub struct ProviderReputationTracker {
    ...
    /// can still build without `a3net-reputation`.
    scores: Option<Arc<PeerScoreTable>>,
    /// Tunable weights. Defaults from `a3net-reputation`.
    #[allow(dead_code)]
...
impl ProviderReputationTracker {
    ...
    pub fn report_provider(
        ...
        let kind = match reason {
            ReportReason::Spam => a3net_reputation::ReportKind::Spam,
            ReportReason::Harassment => a3net_reputation::ReportKind::Harassment,
            ReportReason::Impersonation => a3net_reputation::ReportKind::Impersonation,
            ReportReason::Phishing => a3net_reputation::ReportKind::Phishing,
            ReportReason::Other | ReportReason::MisleadingMetadata
            | ReportReason::LicenseViolation | ReportReason::MaliciousContent => {
                a3net_reputation::ReportKind::Other
            }
        };
