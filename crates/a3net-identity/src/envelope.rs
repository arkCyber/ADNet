...
//! [`EciesCiphertext`] that makes A3Net's encrypted messages
...
//! ```
//!
//! - `magic` = `b"ADEN"` — lets log scanners and protocol police spot A3Net
...
/// Plain payload, opaque to A3Net. A3Net does not inspect this; it can be
...
impl SealedEnvelope {
    ...
    /// (think: a whole `a3net-blob://` ticket) and the binary form is
