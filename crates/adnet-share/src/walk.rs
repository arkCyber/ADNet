...
//!
//! This is the ADNet port of `n0-computer/sendme@0.36.0/src/main.rs::import()`.
...
//!   the higher-level async shim in `adnet-share`'s iroh-feature
...
pub struct WalkOptions {
    ...
    /// ADNet), they are surfaced as [`ShareError::SymlinkRefused`].
    pub allow_symlinks: bool,
    /// Skip hidden files (anything whose name starts with `.`).
    /// sendme does not, but most ADNet operators will not want their
