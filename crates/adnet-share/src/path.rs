...
//! [`crate::collection`].
//!
//! These are a hardened, ADNet-flavoured port of `canonicalized_path_to_string`
...
//!    error message is structured for ADNet's logs.
...
///
/// sendme does not enforce an explicit cap; ADNet picks 512 bytes to
