//! `a3net-observability` — Counter / Gauge / Histogram metrics for A3Net.
//!
...
//!    exactly fits A3Net's three primitive types.
...
//!    convention used in
//!    `a3net-transport/src/iroh/discovery/diagnostics.rs` is
//!    applied here.
...
//! assert!(output.text().contains("a3net_demo_requests_total 3"));
//! ```
//!
//! ### Tracing
//!
...
//!
//! let config = TracingConfig::new("a3net-node")
...
/// `use a3net_observability::prelude::*;` and not the full module
/// tree.
pub mod prelude {
