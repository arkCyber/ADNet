...
//!
//! When ADNet ships a single binary that hosts both the iroh
//! DERP server (`crates/adnet-relay/src/derp`) and the WAN HTTP
//! relay (`crates/adnet-relay/src/server`), operators also need a
