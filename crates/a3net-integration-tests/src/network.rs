...
mod tests {
    ...
    use a3net_dht::{DhtNode, DhtConfig, RoutingTable, Contact};
    ...
    async fn test_gossip_two_nodes() {
        ...
        let room: a3net_types::RoomId = "test-room".into();
        ...
        let ann = a3net_types::Announcement {
            room_id: room.clone(),
            content_hash: a3net_types::ContentHash::from_bytes(b"test-content"),
            node_id: node1_id,
    ...
    async fn test_gossip_multi_node_broadcast() {
        ...
        let room: a3net_types::RoomId = "broadcast-room".into();
        ...
        let ann = a3net_types::Announcement {
            room_id: room.clone(),
            content_hash: a3net_types::ContentHash::from_bytes(b"broadcast-content"),
    ...
    async fn test_gossip_room_isolation() {
        ...
        let room1: a3net_types::RoomId = "room-1".into();
        let room2: a3net_types::RoomId = "room-2".into();
        ...
        let ann1 = a3net_types::Announcement {
            room_id: room1.clone(),
            content_hash: a3net_types::ContentHash::from_bytes(b"room1-content"),
    ...
    async fn test_dht_gossip_integration() {
        ...
        let room: a3net_types::RoomId = "dht-gossip-room".into();
