...
mod tests {
    ...
    async fn test_bitswap_wantlist() {
        ...
        let _ = std::any::type_name::<a3net_blobstore::BitswapEngine>();
    }
    ...
    async fn test_graphsync_requester() {
        ...
        let _ = std::any::type_name::<a3net_blobstore::GraphSyncRequester>();
    }
    ...
    async fn test_ipns_record_creation() {
        ...
        // This would use a3net_namespace functionality
    }
    ...
    async fn test_car_roundtrip() {
        ...
        let dir = temp_dir();
        let store = a3net_blobstore::BlobStore::new(dir.path())
