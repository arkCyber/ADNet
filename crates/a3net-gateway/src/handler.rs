...
<body>
    <h1>A3Net IPFS Gateway</h1>
    <p>Welcome to the A3Net HTTP Gateway. This gateway provides IPFS-compatible access to content on the A3Net network.</p>
...
GET /api/v0/version - Gateway version</pre>
    ...
    async fn handle_node_id(&self) -> Result<Response<Full<Bytes>>, GatewayError> {
        ...
        let response = serde_json::json!({
            ...
            "PublicKey": "",
            "Addresses": [],
            "AgentVersion": "a3net-gateway/0.1.0",
...
pub async fn start_gateway(
    ...
    info!("Starting A3Net IPFS Gateway on {}", addr);
