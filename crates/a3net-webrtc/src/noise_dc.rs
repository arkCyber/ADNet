...
//!
//! The handshake is identical in shape to the one used by `a3net-dht`:
...
//! primitives already used by A3Net (x25519, ChaCha20-Poly1305, SHA-256).
//!
