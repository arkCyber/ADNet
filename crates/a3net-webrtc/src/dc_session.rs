...
//! runs the Noise handshake, and hands off to the regular A3Net frame
//! codec.
//!
//! ## Round-1 status
//!
...
//! - Properly bridge the `FrameCodec` (length-prefixed A3Net frames) with
...
pub const CHANNEL_LABEL: &str = "a3net/0";
