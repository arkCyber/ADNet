...
//! AI models using ADNet's Iroh-based infrastructure.
//!
//! ## Features
//!
...
//! via `adnet-model-catalog providers`.
//!
//! ## Quick Start
//!
//! ```rust,ignore
...
//! };
//! use adnet_model_catalog::provider::ModelMetadata;
//!
...
//!     .with_quantization(adnet_model_catalog::Quantization::Q4("K_M".into()))
