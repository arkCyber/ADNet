...
function copyTicket() {{
    navigator.clipboard.writeText('{}').then(() => {{
        alert('Ticket copied! Your ADNet client will start downloading.');
        window.close();
    }});
}}
</script>
...
<body>
    <div class="container">
        ...
        <footer>
            <p>ADNet Model Catalog &mdash; Powered by Iroh P2P</p>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Browse Models - ADNet Model Store</title>
    <style>
        * {{ margin: 0; padding: 0; box-sizing: border-box; }}
        body {{ font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; background: linear-gradient(135deg, #1a1a2e 0%, #16213e 100%); color: #e0e0e0; min-height: 100vh; }}
        .container {{ max-width: 1200px; margin: 0 auto; padding: 2rem; }}
...
<body>
    <div class="container">
        <header>
            <div class="logo">ADNet Models</div>
            <nav>
                <a href="/">Home</a>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Search: {} - ADNet Model Store</title>
    <style>
        * {{ margin: 0; padding: 0; box-sizing: border-box; }}
        body {{ font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; background: linear-gradient(135deg, #1a1a2e 0%, #16213e 100%); color: #e0e0e0; min-height: 100vh; }}
        .container {{ max-width: 900px; margin: 0 auto; padding: 2rem; }}
...
mod tests {
    ...
    fn index_html_contains_branding() {
        ...
        assert!(html.contains("ADNet Model Store"));
