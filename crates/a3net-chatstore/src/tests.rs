...
use a3net_types::invariants::{AttachmentKind, MemberRole, MessageType};
...
fn save_friend_rejects_bad_name() {
    ...
    let bad = Friend {
        friend_id: "user_b".into(),
        name: "x".repeat(a3net_types::invariants::MAX_NAME_LEN + 1),
        avatar_url: None,
        status: None,
        last_seen: None,
        created_at: None,
...
fn save_direct_messages_batch_is_atomic() {
    ...
    // some a3net_types builds, but `validate()` accepts sequence=0).
