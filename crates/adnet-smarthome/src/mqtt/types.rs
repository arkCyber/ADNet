...
/// MQTT topic namespace for ADNet smart home devices.
///
/// Topics follow the pattern: `adnet/{device_id}/{property}`
/// Commands use: `adnet/{device_id}/set`
#[derive(Debug, Clone)]
...
impl MqttTopic {
    ...
    /// Example: `adnet/lamp-1/2.1` (for siid.piid)
