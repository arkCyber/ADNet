//! `adnet-dht` — Kademlia-style DHT routing for ADNet.
//!
//! This crate implements a simplified Kademlia DHT for content routing and peer discovery.
//! It complements the existing Pkarr/DNS/mDNS discovery in ADNet by adding:
...
//! ## Design
//!
//! The DHT is designed to integrate with ADNet's existing infrastructure:
...
//!
//! ```rust,ignore
//! use adnet_dht::{DhtNode, DhtKey, RoutingTable};
...
pub use handler::{DhtProtocolHandler, DhtEvent};
