...
fn main() -> anyhow::Result<()> {
    println!("╔══════════════════════════════════════════════════════════════════════════════╗");
    println!("║           ADNet Complete Pairing Invitation Workflow Demo                   ║");
    println!("╚══════════════════════════════════════════════════════════════════════════════╝");
    println!();
    ...
    println!("│    - ADNET- prefix identifies this as an ADNet code");
    ...
    let qr_url = adnet_pairing::wire::PairingInvitation::to_url(&alice_invitation)?;
    ...
    let qr_svg = adnet_qr::generator::create_qr_svg(&qr_url)?;
    ...
    let email_content = InvitationContent {
        ...
        body: "Hi Bob! Please pair with my ADNet device using the attached file.".into(),
    };
    ...
    let received_mail = adnet_mail::mime::Mail::from_wire_bytes(&wire_bytes)?;
