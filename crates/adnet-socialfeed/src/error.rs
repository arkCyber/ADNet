//! Error type for `adnet-socialfeed`.
//!
...
//! coming from [`adnet_types`] are mapped to the `Validation`
...
/// Helper: convert from [`adnet_types::AdnetError`] into
...
impl From<adnet_types::AdnetError> for SocialFeedError {
    fn from(e: adnet_types::AdnetError) -> Self {
        match e {
            adnet_types::AdnetError::Validation(m) => SocialFeedError::Validation(m),
