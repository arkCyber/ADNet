//! `a3net-exit-node` — gateway / exit-node routing for the
//! A3Net mesh VPN.
//!
//! ## Two roles
//!
...
//!
//! ```text
//!   a3net-tun          ← packet capture
//!   a3net-mesh-firewall ← per-packet decision
//!   a3net-exit-node     ← (this crate) gateway routing
//! ```
