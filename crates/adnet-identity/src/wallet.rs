...
impl Wallet {
    ...
    pub fn generate() -> Self {
        ...
        let public = WalletPublic::from_secret(&secret).expect("valid secret just generated");
        Self { secret, public }
    }
    ...
    pub fn from_bytes(bytes: &[u8]) -> Result<Self> {
        ...
        let public = WalletPublic::from_secret(&secret)?;
    ...
    /// digest (sha256, blake3, keccak256, …); ADNet's standard policy is
...
impl WalletPublic {
    ...
    /// Recover an ADNet wallet public key from a personal_sign signature.
    ///
