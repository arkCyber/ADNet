//! `a3net-webtransport` — WebTransport (HTTP/3) transport for A3Net.
//!
...
//! ## Wire model
//!
//! 1. The server binds an HTTPS endpoint (`https://host:port/a3net`) and
...
//!    (see `a3net-webrtc::noise_dc`).
//! 4. After Noise completes, additional streams are tagged with the
//!    A3Net channel-id and carry [`Frame`](a3net_types)s.
//!
//! ## Feature flags
//!
