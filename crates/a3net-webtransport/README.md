...
WebTransport (HTTP/3) transport for A3Net. Browser-friendly, symmetric
...
| `a3net-transport::webtransport::WebTransportAdapter` | ⏳ Round-2 |
...
```
a3net-wt-v1:<base64url(payload_json)> \x00 <base64url(hmac_sha256(secret, payload_json))>
```
