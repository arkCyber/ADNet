//! `a3net-mail` — SMTP/IMAP client + spam filtering for the A3Net workspace.
//!
...
//! copies **only** the email-transport subset, and only what the A3Net
...
//!
//! ## New A3Net-specific modules
//!
//! - [`spam`] — Client-side spam filtering with header/content analysis.
//! - [`user_integration`] — Bridge to A3Net identity and user systems.
//!
//! ## Crate layout
//!
...
//! - [`user_integration`] — A3Net identity and user system integration.
//!
