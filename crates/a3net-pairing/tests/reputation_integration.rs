//! Integration tests for the `a3net-reputation` × `a3net-pairing`
//! bridge. Requires the `reputation` feature on `a3net-pairing` so
...
/// that the rest of A3Net (gossipsub, bitswap) reacts to.
#[test]
