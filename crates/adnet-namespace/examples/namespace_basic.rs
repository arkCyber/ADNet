//! `adnet-namespace` 最小示例：生成一个 Ed25519 密钥、构造 publisher + resolver，
//! 演示一次完整的 publish / resolve 往返。**不**接外部传输。
//!
//! 运行：`cargo run -p adnet-namespace --example namespace_basic`

use std::sync::Arc;
use std::time::Duration;

use adnet_namespace::{Ed25519SecretKey, IpnPublisher, IpnResolver};
