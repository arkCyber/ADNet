//! `a3net-userstore` — per-user profile persistence.
//!
//! ## Why this crate exists
//!
//! `a3net-chatstore` already owns the `users` row that came out of
...
//! [`a3net_roster::stable_digit_from_node`] so the same algorithm produces
