//! `a3net-gossip` — topic-based pub/sub overlay.
//!
//! Three layers:
//!
...
//!    [`Announcement`](a3net_types::Announcement) and routes them by
//!    [`Topic`](a3net_types::Topic).
//!
...
pub use a3net_types::{Announcement, AnnouncementPayload, NodeId, Topic};
