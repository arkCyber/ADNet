//! Integration tests for `a3net-gossip`.
//!
...
//! tests (e.g. `a3net-node/tests/iroh_e2e.rs`).

use std::sync::Arc;
use std::time::Duration;

use a3net_gossip::{GossipBus, InProcessGossip, dedup::{DedupeFilter, TtlTracker, DEFAULT_MESSAGE_TTL}};
use a3net_types::{
