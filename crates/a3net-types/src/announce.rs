...
/// be done with care. Mirrors `a3net_token::PledgeBody::digest`'s
...
///
/// This is the wire format flowing through both [`a3net-gossip`](crate) and
...
impl Announcement {
    ...
    /// `a3net-identity::Wallet::sign_personal` over `blake3(preimage)`).
    ///
