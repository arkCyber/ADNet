...
impl BulletinId {
    ...
    pub fn derive(
        ...
        hasher.update(b"a3net-bulletin/v1");
...
impl BulletinItem {
    ...
    /// verbatim; the verifier (in `a3net-news::service`) is
    ...
    pub fn validate(&self) -> Result<()> {
        ...
        // signature here (no crypto deps in `a3net-types`); the
...
fn bulletin_integrity_hash(
    ...
    h.update(b"a3net-bulletin-integrity/v1");
