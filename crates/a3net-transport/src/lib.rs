//! `a3net-transport` — abstract transport layer.
//!
//! Public trait [`Transport`] defines the operations `a3net-node` consumes:
...
//! mesh HTTP layer in `a3net-mesh` remains the always-on fallback transport.
