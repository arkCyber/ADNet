//! DHT protocol integration for a3net-transport.
//!
//! This module provides the integration layer between the DHT protocol
//! and the A3Net transport layer, enabling DHT messages to be sent
...
impl DhtTransportIntegration {
    ...
    pub fn encode_message(msg: &DhtWireMessage) -> Result<Vec<u8>, a3net_dht::CodecError> {
        DhtCodec::encode(msg)
    }

    /// Decode a DHT message from received bytes.
    pub fn decode_message(bytes: &[u8]) -> Result<DhtWireMessage, a3net_dht::CodecError> {
