...
//! arbitrary A3Net `NodeId` or a native-QUIC certificate fingerprint as an
//! iroh identity.
//!
//! # Safety properties
//!
...
/// Default filename below an A3Net node's data directory.
...
impl IrohIdentity {
    ...
    /// A3Net `NodeId` containing the exact EndpointId public-key bytes.
