//! `a3net-mesh-coordinator` — coordinator-side admission for
...
//!
//! ```text
//!   a3net-cli (ray invite / ray requests)
//!                  │
//!                  ▼
//!   a3net-mesh-coordinator  ←  this crate
//!                  │
//!                  ▼
//!   a3net-types (MeshMember / MeshMembership / InviteCode)
//! ```
