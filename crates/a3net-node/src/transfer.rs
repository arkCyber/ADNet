...
//! plug in mesh HTTP, QUIC, or iroh-blobs without `a3net-node` taking a
...
use a3net_types::{BlobTicket, ContentHash, RangeSpec};
...
/// `a3net-mesh` HTTP API. A future `IrohBlobsBackend` (behind the `iroh`
/// feature on `a3net-blobstore`) can satisfy the same trait and benefit
