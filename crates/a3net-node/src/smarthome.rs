...
//!
//! Feature-gated behind `smarthome` (= `dep:a3net-smarthome`). Wires a
//! [`a3net_smarthome::SmartHomeHub`] (device registry, mDNS discovery,
...
use a3net_smarthome as smarthome;
