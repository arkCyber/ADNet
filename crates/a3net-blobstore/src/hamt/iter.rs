        ...
        for i in 0..10 {
            ...
            shard
                .insert(
                    name,
                    HamtEntry::File {
                        hash: a3net_types::ContentHash::from_bytes(
    ...
    fn test_prefix_iteration() {
        ...
        shard
            .insert(
                ...
                HamtEntry::File {
                    hash: a3net_types::ContentHash::from_bytes(b"content2"),
                    size_bytes: 8,
                },
            )
            .unwrap();
        shard
            .insert(
                "other.txt".to_string(),
                HamtEntry::File {
                    hash: a3net_types::ContentHash::from_bytes(b"content3"),
                    size_bytes: 8,
                },
            )
            .unwrap();
    ...
    fn test_directory_filter() {
        ...
        shard
            .insert(
                "subdir".to_string(),
                HamtEntry::Directory {
                    hash: a3net_types::ContentHash::from_bytes(b"dir1"),
                    entry_count: 5,
                },
            )
            .unwrap();
