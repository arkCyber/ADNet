...
impl BlobStore {
    ...
    /// Refresh the `a3net_blob_store_size_bytes` and
    /// `a3net_blob_blobs_total` gauges from the current store
...
mod tests {
    ...
    fn import_export_roundtrip() {
        ...
        std::fs::write(&src, b"a3net-p2p-blob-payload").unwrap();
        ...
        assert_eq!(bytes, b"a3net-p2p-blob-payload");
    }
    ...
    /// `a3net_blob_store_size_bytes` and `a3net_blob_blobs_total`.
    #[test]
