...
//! [`VirtualIp`](a3net_types::VirtualIp) of the member
...
use a3net_types::{MeshMember, MeshMembership, NodeId, VirtualIp, VirtualIpv4};
...
mod tests {
    use super::*;
    use a3net_types::{MeshNetworkId, MeshPolicy};
