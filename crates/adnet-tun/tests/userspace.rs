...
use adnet_tun::packet::{IpProtocol, IpVersion, parse_packet};
use adnet_tun::{DeviceState, TunDevice, UserspaceTun, UserspaceTunConfig};
...
async fn info_reflects_lifecycle() {
    ...
    assert_eq!(info.name, "adnet-tun0");
