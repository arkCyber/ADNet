//! Internationalization (i18n) support for ADNet CLI.
//!
...
//!
//! ```rust
//! use adnet_tui::i18n::{t, set_locale, Locale};
//!
//! // Set locale
...
static TRANSLATIONS: Lazy<HashMap<&'static str, HashMap<&'static str, &'static str>>> =
    Lazy::new(|| {
        ...
        en.insert("status.title", "ADNet Node Status");
        ...
        // Wizard translations
        en.insert("wizard.title", "ADNet Configuration Wizard");
        en.insert("wizard.intro", "This wizard will help you set up ADNet configuration step by step.");
        ...
        en.insert("wizard.data_dir_help", "Where ADNet stores its data");
        ...
        zh.insert("status.title", "ADNet 节点状态");
        ...
        // Wizard translations
        zh.insert("wizard.title", "ADNet 配置向导");
        zh.insert("wizard.intro", "本向导将帮助您逐步设置 ADNet 配置。");
        ...
        zh.insert("wizard.data_dir_help", "ADNet 存储数据的目录");
...
mod tests {
    ...
    fn test_english_default() {
        ...
        assert_eq!(t("status.title"), "ADNet Node Status");
    }
