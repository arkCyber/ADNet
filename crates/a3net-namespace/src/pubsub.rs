...
//! `a3net-ipns-v1`) and ingests every [`IpnRecord`] it sees into an
//! [`IpnResolver`]. Combined with [`crate::transport::gossip::GossipIpnTransport`]
//! this gives A3Net a libp2p-floodsub-style IPNS-over-PubSub path:
...
use a3net_types::{AnnouncementPayload, RoomId};
...
pub const IPNS_PUBSUB_ROOM: &str = "a3net-ipns-v1";
...
pub fn publish_payload(
    record: &IpnRecord,
    from_node: &str,
    sender_node: a3net_types::NodeId,
) -> Result<AnnouncementPayload, IpnsError> {
