...
//!
//! This module bridges [`adnet_dht::transport::TransportBridge`] to a
...
/// [`AddProvider`](adnet_dht::protocol::DhtWireMessage::AddProvider)
...
impl QuicTransportBridge {
    /// Wrap a `QuicTransport` for use by `adnet-dht` without
