//! `a3net-chain` — framework for a NAS server to also act as a Web3
//! public blockchain node.
//!
//! ## Motivation
//!
//! An A3Net NAS server already has spare disk, bandwidth and uptime.
...
//!   (`start` / `status` / `shutdown`) that callers (e.g. `a3net-node`)
...
//!
//! ```text
//!   a3net-node (optional "chain" feature)
//!                  │
//!                  ▼
//!   a3net-chain              ←  this crate
//!                  │
//!                  ▼
//!   a3net-types (shared primitives only; no chain-specific types yet)
//! ```
