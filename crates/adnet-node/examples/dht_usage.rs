//! Example: Using DHT routing in adnet-node.
//!
...
//!
//! Run with: `cargo run --example dht_usage --features adnet-node/dht`
...
use adnet_node::{DhtConfig, DhtHandle, IpnConfig};
...
async fn main() -> anyhow::Result<()> {
    ...
    let secret_key: Arc<dyn adnet_namespace::SecretKey> = Arc::new(Ed25519SecretKey::generate());
