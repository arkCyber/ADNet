//! Bitswap integration for adnet-node.
//!
//! This module integrates the Bitswap content exchange protocol with the ADNet
//! node, enabling:
//!
...
//!
//! Local-content announcements ride on [`adnet_gossip::GossipBus`]. The
...
use adnet_blobstore::{BlobStore, BitswapEngine, BitswapMessage};
use adnet_gossip::{Announcement, GossipBus};
...
/// Bitswap handle for adnet-node integration.
///
