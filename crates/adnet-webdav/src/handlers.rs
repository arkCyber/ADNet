...
impl HandlerState {
    ...
    fn verify_and_authorise(
        ...
        verb: &str,
        header: Option<&str>,
    ) -> Result<adnet_pairing::CapabilitySet, HttpError> {
    ...
    pub fn handle_put(
        ...
        let quota = adnet_blobstore::NoopQuota;
        self.nas
...
fn map_ns(e: adnet_blobstore::NamespaceError) -> HttpError {
    use adnet_blobstore::NamespaceError::*;
    match e {
...
mod tests {
    ...
    impl adnet_blobstore::Clock for MockClock {
