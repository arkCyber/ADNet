//! `adnet-webdav` — WebDAV gateway for the NAS namespace.
//!
//! DO-178C **DAL-A** module. Surfaces `adnet-blobstore::Nas` as a
...
//! The default resolver accepts an `adnet-pairing`-issued capability
...
/// for `adnet-webdav`. Mirrors `adnet-blobstore::aerospace` —
