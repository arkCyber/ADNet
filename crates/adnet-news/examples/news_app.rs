...
//! Run with:
//! ```bash
//! cargo run -p adnet-news --example news_app
//! ```

use adnet_gossip::{GossipTransport, InProcessGossip};
use adnet_news::{BulletinEvent, BulletinItem, NewsService, NewsServiceConfig, ValidationPolicy};
use adnet_types::{
...
fn make_item(
    ...
    title: &str,
    body: &str,
    supersedes: Option<adnet_types::BulletinId>,
    nonce: &[u8],
