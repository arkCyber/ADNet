...
use a3net_types::social_feed::SocialPost;
...
async fn main() -> anyhow::Result<()> {
    ...
    let post = svc.create_post(SocialPost {
        ...
        attachments: vec![],
        tags: vec![],
        visibility: a3net_types::invariants::Visibility::Public,
        location: None,
        mentions: vec![],
        created_at: 0,
        updated_at: 0,
...
```
        ...
        └────────────────────────────┘
                 ...
                 ▼
        ┌────────────────────────────┐
        │  a3net-types::social_feed   │  ← typed records + Validate
        └────────────────────────────┘
```
...
```bash
a3net moments post --author alice --visibility public -- "hello world"
a3net moments timeline bob --limit 20
a3net moments comment <post_id> --author bob -- "nice!"
a3net moments react <target_id> --target-type post --user-id bob --reaction like
a3net moments follow bob alice
a3net moments unfollow bob alice
```
