...
use a3net_gossip::transport::GossipTransport;
...
pub struct SocialFeedServiceConfig {
    ...
    pub validation_policy: a3net_ipc::validation::ValidationPolicy,
...
pub use a3net_types::social_feed::PostAttachment as Attachment;
