//! `a3net-socialfeed` — Social feed (朋友圈 / Moments) runtime for A3Net.
//!
...
//! the A3Net workspace. The original code only had:
//!
...
//!
//! The port re-shapes that into A3Net's layered architecture:
//!
//! - **Types** live in [`a3net_types::social_feed`] (already in
...
//! `validate()` methods (see [`a3net_types::social_feed`]). The
