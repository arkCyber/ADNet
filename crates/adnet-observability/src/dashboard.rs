...
//! status pages / `adnet status` can consume. The metrics
...
pub const NAME_BLOBSTORE_SIZE: &str = "adnet_blob_store_size_bytes";
pub const NAME_BLOBSTORE_BLOBS: &str = "adnet_blob_blobs_total";
pub const NAME_REPLICATOR_SWEEPS: &str = "adnet_replicator_sweeps_total";
pub const NAME_REPLICATOR_PUSHES: &str = "adnet_replicator_blocks_pushed_total";
pub const NAME_REPLICATOR_PUSH_ERRORS: &str = "adnet_replicator_push_errors_total";
pub const NAME_REPLICATOR_HASHES: &str = "adnet_replicator_hashes_verified_total";
pub const NAME_REPLICATOR_UNDER: &str = "adnet_replicator_under_replicated_blocks";
pub const NAME_REPLICATOR_FULL: &str = "adnet_replicator_fully_replicated_blocks";
pub const NAME_SHARE_RECEIVE_BYTES: &str = "adnet_share_receive_bytes_total";
pub const NAME_SHARE_RECEIVE_FILES: &str = "adnet_share_receive_files_total";
pub const NAME_SHARE_RECEIVE_ERRORS: &str = "adnet_share_receive_errors_total";
pub const NAME_BLOBSTORE_READ_HASH_MISMATCH: &str = "adnet_blob_read_hash_mismatch_total";
pub const NAME_BLOBSTORE_QUARANTINED: &str = "adnet_blob_quarantined_total";
pub const NAME_BLOBSTORE_IMPORT_PATH_REJECTED: &str = "adnet_blob_import_path_rejected_total";
...
mod tests {
    ...
    fn dashboard_unknown_metric_lands_in_extras() {
        let reg = Arc::new(Registry::default());
        let c = reg.register_counter("adnet_test_widget_total", "demo");
        c.inc_by(7);
        let dash = DashboardBuilder::new(Arc::clone(&reg)).build();
        assert_eq!(
            dash.extras["adnet_test_widget_total"]["value"].as_u64(),
            Some(7)
        );
    }
