//! OpenTelemetry tracing support for ADNet.
//!
...
pub struct TracingConfig {
    ...
    /// Console/log output filter (e.g., "info,adnet=debug").
...
pub fn init_tracing(config: &TracingConfig) -> Result<(), TracingError> {
    ...
    let tracer = tracer_provider.tracer("adnet");
