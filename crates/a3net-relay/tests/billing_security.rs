...
//!
//! ```text
//! cargo test -p a3net-relay --features billing --test billing_security
//! ```
...
use a3net_identity::{Treasury, Wallet};
use a3net_relay::{BillingMode, BillingState, BillingStore, RelayServer};
...
async fn start_relay(wallet: Arc<Wallet>) -> a3net_relay::RelayServerHandle {
