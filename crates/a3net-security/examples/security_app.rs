//! Realistic example: a small A3Net "node" combines ACL, audit log,
...
//! Run with:
//! ```bash
//! cargo run -p a3net-security --example security_app
//! ```

use chrono::Duration;

use a3net_security::acl::{Permission, Resource, ResourceType, Subject};
use a3net_security::audit::{
    AuditConfig, AuditEventType, AuditLog, AuditOutcome, AuditRecord,
};
use a3net_security::key_management::{KeyRotationPolicy, KeyStore, KeyType};
use a3net_security::{
