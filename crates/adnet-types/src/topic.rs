...
//!
//! A topic is a 32-byte opaque identifier. ADNet derives topics from a string
//! label (`"adnet-room-{room_id}"`) so that human-readable names map
