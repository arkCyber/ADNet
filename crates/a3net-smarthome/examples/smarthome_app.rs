//! Realistic a3net-smarthome app example.
//!
...
//!
//! ```bash
//! cargo run -p a3net-smarthome --example smarthome_app
//! ```
//!
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let api_handle = a3net_smarthome::api::serve(
        hub.clone(),
        a3net_smarthome::api::ApiConfig {
