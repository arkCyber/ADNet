...
//!
//! A3Net Smart Home Hub supports HomeKit through Matter protocol bridge:
//!
...
//!
//! ## A3Net Matter-HomeKit Mapping
//!
//! A3Net automatically maps device capabilities to Matter clusters, which Apple
//! recognizes as compatible HomeKit functionality:
//!
//! | A3Net Capability | Matter Cluster | HomeKit Equivalent |
//! |------------------|---------------|-------------------|
...
//!
//! ## Using A3Net with Apple Home
//!
//! 1. Commission Matter devices through A3Net's REST API or CLI
...
impl HomeKitAccessory {
    ...
    /// Convert an A3Net device to HomeKit accessories.
    /// This maps A3Net capabilities through Matter clusters to HomeKit equivalents.
...
impl Default for HomeKitConfig {
    fn default() -> Self {
        Self {
            name: "A3Net Smart Hub".into(),
            port: 51827,
            pin: "123-45-678".into(),
            model: "A3Net-Hub-1".into(),
            manufacturer: "A3Net".into(),
...
/// Convert A3Net device capabilities to a HomeKit category.
...
/// Convert A3Net capability to a HomeKit characteristic.
